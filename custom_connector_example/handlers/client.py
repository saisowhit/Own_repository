...
RESOURCE='https://amtrakdev106c5dd72b7ca8401cdevaos.ax7cloud.dynamics.com/data'
...
class HttpsClient:
    def __init__(self, access_token,type):
        ...
        # self.type=type
        # self.authorization_header = {'Authorization': 'Bearer '+ type + access_token}
        # self.post_data={'client_id':CLIENT_ID,'client_secret': CLIENT_SECRET,'grant_type':GRANT_TYPE,'resource':RESOURCE})
